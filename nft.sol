...
contract NFToshis is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://gateway.pinata.cloud/ipfs/QmUhCPwnV26Se83oJBg5dQKf3Dubcg8fDz2mhNEnf6AQfG";

  constructor() 
    ERC721("NFToshi", "Toshis")
